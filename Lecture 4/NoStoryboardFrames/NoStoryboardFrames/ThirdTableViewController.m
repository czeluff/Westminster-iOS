...
//  NoStoryboardFrames
//
//  Created by Chad Zeluff on 5/12/14.
...
- (void)viewDidLoad
{
    ...
    self.studentsArray = @[@"Chad", @"Greg", @"Talus", @"Morgan", @"Patrick H", @"Patrick A", @"Aidan", @"Charles", @"Tanner"];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    NSLog(@"%@", self.studentsArray[indexPath.row]);
}
